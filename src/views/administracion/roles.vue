<template>
        ...
        >
            <v-card v-if="rolSeleccionado">
                ...
                <div class="container mt-5">
                    ...
                    <v-checkbox
                        v-for="(item, index) in codigosPermisosExternos" :key="index"
                        v-model="listaPermisosSeleccionados[index]"
                        :label="`${nombresPermisosExternos[index]}`"
                    ></v-checkbox>
  ...
  <script>
  import { codigosPermisosExternos, nombresPermisosExternos } from '@/helpers/permisosExternos'
  ...
  export default {
    ...
    data() {
        return {
            listaRoles: [],
            codigosPermisosExternos: [],
            nombresPermisosExternos: [],
    ...
    methods: {
        ...
        async crearRol () {
            ...
            try {
                ...
                for (let i = 0; i < this.datosRolNuevo.listaPermisosSeleccionados.length; i++) {
                    ...
                    if (element) permisos.push(this.codigosPermisosExternos[i])
                }
        ...
        async actualizarPermisosDelRol () {
            ...
            try {
                ...
                for (let i = 0; i < listaPermisosSeleccionadosActual.length; i++) {
                    ...
                    if (elementNuevo) {
                        idsPermisoAdd.push( this.codigosPermisosExternos[i] )
                    }
                    
                    if (elementActual && !elementNuevo) {
                        idsPermisoDelete.push( this.codigosPermisosExternos[i] )
                    }
                }
        ...
        getListaPermisosSeleccionados () {
            const listaPermisosSeleccionadosAux = Array.from({length: this.codigosPermisosExternos.length}, (v, i) => false)
            for (let i = 0; i < this.codigosPermisosExternos.length; i++) {
                const permiso = this.codigosPermisosExternos[i]
    ...
    watch: {
        ...
        dialogCreacion: function () {
            const listaPermisosSeleccionadosAux = Array.from({
                length: this.codigosPermisosExternos.length
            }, (v, i) => false)
    ...
    async created () {
        ...
        this.codigosPermisosExternos = codigosPermisosExternos
        this.nombresPermisosExternos = nombresPermisosExternos
